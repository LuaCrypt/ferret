...
pub const OPCODE_DEFS: &[(Op, &str)] = &[
    ...
    (Op::Call, "OP_CALL"),
    (Op::CallVarArg, "OP_CALLVARARG"),
    (Op::CallOpen, "OP_CALLOPEN"),
    ...
    (Op::CallN, "OP_CALLN"),
    (Op::CallNVarArg, "OP_CALLNVARARG"),
    (Op::CallNOpen, "OP_CALLNOPEN"),
    (Op::Call3, "OP_CALL3"),
    (Op::ReturnCall, "OP_RETURNCALL"),
    (Op::ReturnCallOpen, "OP_RETURNCALLOPEN"),
    (Op::SetTableCall, "OP_SETTABLECALL"),
    (Op::SetTableVarArg, "OP_SETTABLEVARARG"),
